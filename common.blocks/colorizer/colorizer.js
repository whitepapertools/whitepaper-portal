...
$('.colorizer__color_view_whitepaper').click(function(){
	$('.colorizer__color').removeClass('colorizer__color_state_active');
...
/* Влючить на megafon */
$('.colorizer__color_view_megafon').click(function(){
	$('.colorizer__color').removeClass('colorizer__color_state_active');
	$(this).addClass('colorizer__color_state_active');
...
/* Влючить на mts */
$('.colorizer__color_view_mts').click(function(){
	$('.colorizer__color').removeClass('colorizer__color_state_active');
	$(this).addClass('colorizer__color_state_active');
