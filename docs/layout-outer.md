...
Сначала сетке нужно задать правила деления страницы по вертикали в процентном соотношении. Для этого нужно задать модификатору `structure` нужное значение. Если на странице должно быть боковое меню, выбирай значение с префиксом `fold` (свернутое) или `unfold` (развернутое).
...
`structure`   | `fold-10` `fold-25-50-25` `fold-30-70` `fold-50-50` `fold-70-30`           | Разделение страницы на секции со свёрнутым меню
`structure`   | `unfold-100` `unfold-25-50-25` `unfold-30-70` `unfold-50-50` `unfold-70-3`  | Разделение страницы на секции с развернутым меню
