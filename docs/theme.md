...
size               | default                                                    | размер и высота строк типографики
space              | default                                                    | размер отступов

## Новая тема

Чтобы создать тему для своего проекта, нужно скопировать на [уровень своего проекта](whitepaper-stub.md) блок `theme`. Файловая структура блока:

```
theme/
	color/
		default.css 	// по аналогии нужно создать файл с названием своей темы
	space/
		default.css 	// по аналогии нужно создать файл с названием своей темы
	size/
		default.css 	// по аналогии нужно создать файл с названием своей темы
