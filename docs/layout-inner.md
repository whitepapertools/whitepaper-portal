...
Если на вашем проекте сетка с другим количеством колонок, необходимо создать нужное значение модификатора на [уровне проекта](whitepaper-stub.md).
