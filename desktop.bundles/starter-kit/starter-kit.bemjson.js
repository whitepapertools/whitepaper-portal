                              ...
                              content: [
                                ...
                                },
                                {
                                  ...
                                  content: [
                                    {
                                      elem: 'contacts',
                                      mix: { block: 'pt-list', mods: { 'space-v': 'xs' } },
                                      content: [
                                        {
                                          block: 'pt-list',
                                          elem: 'item',
                                          ...
                                          content: [
                                            {
                                              ...
                                              mix: [
                                                { block: 'pt-icon-plus', elem: 'icon', elemMods: { 'indent-r': 's' } },
                          ...
                          content: [
                            {
                              ...
                              content: [
                                  ...
                                  content: [
                                    {
                                      block: 'event',
                                      elem: 'description',
                                      mix: [{ block: 'pt-card', elem: 'content', elemMods: { distribute: 'between', 'space-a': 'l' } },
                                      ],
                                      content: [
                                        {
                                          elem: 'name',
                                        ...
                                        },
                                        {
                                          ...
                                          content: [
                                            {
                                              block: 'text',
                                              mods: { view: 'primary', size: 'xl', weight: 'bold', font: 'sans', align: 'right' },
                                              content: '4.5'
                                            },
                                            {
                                              block: 'text',
                                ...
                                },
                                {
                                  block: 'pt-card',
                                  elem: 'content',
                                  elemMods: { 'vertical-align': 'center', 'space-a': 'l' },
                                  content: [
                                    {
                                      block: 'pt-list',
                                      mods: { 'space-v': 'xs' },
                              ...
                              content: [
                                ...
                                },
                                {
                                  ...
                                  content: [
                                    {
                                      elem: 'collection',
                                      mix: { block: 'pt-list', mods: { 'space-h': 'xl', 'space-v': 'xxs' } },
                                      content: [
                                        {
                                          elem: 'sound',
                      ...
                      content: [
                        {
                          ...
                          mix: [
                            ...
                            { block: 'tpl-grid', elem: 'fraction', elemMods: { 's-col': '3', 'm-col': '2' } }
                          ],
                          content: [
                            {
                              elem: 'content',
                              elemMods: { 'space-a': '2xl' },
                              content: [
                                {
                                  block: 'text',
